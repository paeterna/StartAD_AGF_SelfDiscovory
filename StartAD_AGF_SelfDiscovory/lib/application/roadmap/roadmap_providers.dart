...
final Provider<RoadmapService> roadmapServiceProvider =
    Provider<RoadmapService>((ref) {
      return RoadmapService(Supabase.instance.client);
    });

/// Provider for user's roadmaps
final AutoDisposeFutureProvider<List<Roadmap>> myRoadmapsProvider =
...
final AutoDisposeFutureProviderFamily<RoadmapWithSteps?, String>
roadmapWithStepsProvider = FutureProvider.autoDispose
    .family<RoadmapWithSteps?, String>(
      (ref, roadmapId) async {
        final roadmapService = ref.watch(roadmapServiceProvider);
