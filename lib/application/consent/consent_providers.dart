...
final Provider<ConsentService> consentServiceProvider =
    Provider<ConsentService>((ref) {
      return ConsentService(Supabase.instance.client);
    });

/// Provider for latest consent
final AutoDisposeFutureProvider<Consent?> latestConsentProvider =
...
final AutoDisposeFutureProviderFamily<bool, String> hasAcceptedConsentProvider =
